...
babaGrammars.gitManual = {
	...
	'option-description': [
		...
		'with[[out|]] this {{noun.synonym.option}}, {{command-name}} {{command-option}} {{verb.git|tense.present}} {{noun.git|plural}} that {{verb}} the {{verb.synonym.supply|tense.past}} {{noun.git|plural}}',
	],
}
