...
babaGrammars.gitManual = {
	...
	'subject': '[[you|the user|the {{commandName}} command]]',

	'commandNameRaw': 'git-{{verb.common}}-{{noun.git}}',
	'commandName': '<code>{{commandNameRaw}}</code>',
	'commandOptionRaw': '--[[{{verb.common}}-|]]{{verb.common}}-{{noun.git}}',
	...
	'action': '{{verb.git}} [[{{located-noun|prepend-an}}|{{determiner}} {{located-noun|noun.plural}}]] {{preposition}} {{determiner}} {{verb.git|tense.past}} {{located-noun|noun.plural}}',
	'condition': [
		'{{conjunction.conditional}} {{constant-noun}} is [[not |]]{{verb.git|tense.past}}',
		'{{conjunction.conditional}} {{commandName}} {{verb.git|tense.present}} {{noun.git|prepend-an}}',
	],
	'conclusion': [
	...
	'statement': [
		...
		'{{commandName}} {{commandOption}} {{verb.synonym.will}} {{verb.synonym.perform}} {{adjective.git-action|prepend-an}} {{commandName}} before [[{{verb.git|tense.present-participle}} the {{noun.git}}|doing anything else]]',
		'{{multiple-nouns}} are {{verb.git|tense.past}} to {{constant-noun}} by {{commandName}}',
		...
		'{{subject}} {{verb.synonym.will}} {{verb.git}} {{determiner}} {{noun.git|plural}} {{conjunction.and-or}} run {{commandName}} {{commandOption}} instead',
		'to {{verb.git}} {{adjective.git-action|prepend-an}} {{constant-noun}} {{conjunction.and-or}} {{verb.git}} the working {{noun.git|plural}}, use the command {{commandName}} {{commandOption}}',
		'the {{noun.git}} to be {{verb.git|tense.past}} can be {{verb.synonym.supply|tense.past}} in several ways',
		'the {{commandOption}} {{noun.synonym.option}} can be used to {{verb.git}} {{noun.git|prepend-an}} for the {{noun.git}} that is {{verb.git|tense.past}} by {{adjective.git-action|prepend-an}} {{noun.git}}',
		'any {{verb.git|tense.present-participle}} of {{noun.git|prepend-an}} that {{verb.git|tense.present}} {{noun.git|prepend-an}} {{adverb.synonym.immediately}} after can be {{verb.git|tense.past}} with {{commandName}}',
		...
		'{{commandName}} takes {{noun.synonym.option|plural}} {{adjective.synonym.relevant}} to the {{commandName}} {{noun.synonym.command}} to {{verb.synonym.verify}} what is {{verb.git|tense.past}} and how',
	],
	'command-description': '{{verb.git|tense.present}} [[{{located-noun|prepend-an}}|{{determiner}} {{located-noun|noun.plural}}]] {{preposition}} {{determiner}} {{verb.git|tense.past}} {{located-noun|noun.plural}}, and {{statement}}.',
	'option-description': [
		'{{verb.git}} the {{noun.git|plural}} of any {{noun.git|plural}} that are {{verb.git|tense.past}}',
		...
		'the {{noun.git}} {{verb.synonym.will}} [[not |]]be {{verb|tense.past}} by {{verb.git|tense.past|prepend-an}} {{noun.git}}',
		'use {{noun.git}} to {{verb.git}} {{git-path}} to {{verb.git|prepend-an}} {{noun.git}}',
		'with[[out|]] this {{noun.synonym.option}}, {{commandName}} {{commandOption}} {{verb.git|tense.present}} {{noun.git|plural}} that {{verb}} the {{verb.synonym.supply|tense.past}} {{noun.git|plural}}',
	],
}
